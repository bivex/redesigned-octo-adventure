...
#ifdef UNIT_TESTING
extern void mock_assert(const int, const char * const, const char * const, const char * const, const int);
//-V:1059 // PVS-Studio: intentional assert macro override for unit testing
